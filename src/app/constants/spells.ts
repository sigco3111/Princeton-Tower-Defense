...
export const SPELL_TECH_TREE: Record<SpellType, SpellUpgradeNode[]> = {
  fireball: [
    {
      ...
      description: "메테오 피해량 +15, 더 뜨거운 충격 핵",
      level: 1,
      title: "점화 인장",
    },
    {
      cost: SPELL_UPGRADE_COSTS[1],
      description: "+2 메테오 및 타격 범위 확대. 수동 조준 잠금 해제.",
      level: 2,
      title: "쌍낙 패턴",
    },
    {
    ...
    },
    {
      ...
      description: "갑옷을 관통하는 메테오 피해량 +15",
      level: 4,
      title: "핵 압축",
    },
    {
      cost: SPELL_UPGRADE_COSTS[4],
      description: "+3 메테오 및 종말 확산 축소",
      level: 5,
      title: "천낙 성좌",
    },
    {
  ...
  freeze: [
    ...
    },
    {
      ...
      description: "빙결 지속시간 +0.6초, 전 맵 봉쇄 — 모든 적 빙결",
      level: 5,
      title: "절대 영도의 계약",
    },
    {
  ...
  hex_ward: [
    ...
    {
      cost: SPELL_UPGRADE_COSTS[5],
      description: "소생 +2기 및 방어막 지속시간 +2초",
      level: 6,
      title: "검은 행진",
    },
  ],
  lightning: [
    {
      cost: SPELL_UPGRADE_COSTS[0],
      description: "시전당 연쇄 번개 +2",
      level: 1,
      title: "분기 축전기",
    },
    {
      cost: SPELL_UPGRADE_COSTS[1],
      description: "총 분산 피해량 +120. 수동 조준 잠금 해제.",
      level: 2,
      title: "폭풍 배터리",
    },
    {
    ...
    {
      cost: SPELL_UPGRADE_COSTS[3],
      description: "조밀한 점프 간격으로 연쇄 번개 +2",
      level: 4,
      title: "전도 격자",
    },
    {
      cost: SPELL_UPGRADE_COSTS[4],
      description: "피해량 +120 및 기절 +0.35초",
      level: 5,
      title: "폭풍 위임",
    },
    {
      cost: SPELL_UPGRADE_COSTS[5],
      description: "연쇄 번개 +2 및 총 피해량 +100",
      level: 6,
      title: "천둥군주의 칙령",
    },
  ],
  payday: [
    {
      cost: SPELL_UPGRADE_COSTS[0],
      description: "시전당 기본 지급액 +10",
      level: 1,
      title: "주조된 원장",
    },
    {
      cost: SPELL_UPGRADE_COSTS[1],
      description: "적당 지급액 +2 및 상한 증가",
      level: 2,
      title: "공격적 수익",
    },
    {
    ...
    {
      cost: SPELL_UPGRADE_COSTS[3],
      description: "기본 지급액 추가 +10",
      level: 4,
      title: "왕실 금고",
    },
    {
      cost: SPELL_UPGRADE_COSTS[4],
      description: "적당 지급액 +2 및 오라 +3초",
      level: 5,
      title: "황금 폭포",
    },
    {
      cost: SPELL_UPGRADE_COSTS[5],
      description: "기본 지급액 +10 및 최대 보너스 +20",
      level: 6,
      title: "무한 배당",
    },
  ],
